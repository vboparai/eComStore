...
<nav class="navbar navbar-default navbar-inverse" role="navigation">
  <div class="container-fluid">
    ...
    <form class="form" id="form5" runat="server">
        <div class="form-group">
            <asp:Label ID="cart" runat="server" Text="Your Shopping Cart"></asp:Label><br />
            <asp:Label ID="itemsLabel" runat="server" ></asp:Label><br /><br />

            <asp:Label ID="totalBeforeTaxLabel" runat="server" ></asp:Label><br />
            <asp:Label ID="taxLabel" runat="server" ></asp:Label><br />

            <asp:Label ID="cartPriceLabel" runat="server"></asp:Label><br />
